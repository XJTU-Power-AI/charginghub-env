...
class HubAggregator_v3_1(object):
    ...
    def consult_all_evcs_power(self):
        ...
        self.evcssp_charge_power = []
        self.evcssp_max_demand = []
        self.evcssp_min_demand = []
        self.ag_car_number = []
        ...
        for station in self.evcssp_evs_objects:
            ...
            self.evcssp_charge_power.append(station.charge_power)
            self.evcssp_max_demand.append(station.max_power)
            self.evcssp_min_demand.append(station.min_power)
            self.ag_car_number.append(station.car_number)
            self.ag_full.append(station.car_number >= station.charge_number)
